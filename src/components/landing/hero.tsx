...
function MockupPreview() {
  return (
    <div className="relative mx-auto mt-16 mb-4" style={{ width: "min(860px, 92vw)" }}>
      {/* Glow */}
      <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 pointer-events-none" style={{ width: "70%", height: 120, background: "radial-gradient(ellipse, rgba(108,99,255,0.25) 0%, transparent 70%)", filter: "blur(20px)" }} />

      {/* macOS frame — flex column so content area fills remaining height */}
      <div
      ...
      >
        {/* Menu bar */}
        <div className="flex items-center justify-between px-4 shrink-0" style={{ background: "rgba(28,28,30,0.9)", height: 24 }}>
        ...
        {/* Desktop — flex:1 fills all remaining height */}
        <div style={{ flex: 1, position: "relative", overflow: "hidden" }}>
          {/* Safari window */}
          <div
            className="rounded-lg overflow-hidden absolute"
            style={{ width: "72%", top: "8%", left: "14%", boxShadow: "0 20px 48px rgba(0,0,0,0.55), 0 0 0 0.5px rgba(255,255,255,0.08)" }}
          >
            <div style={{ background: "linear-gradient(180deg,#3a3a3c,#2c2c2e)", padding: "6px 10px 0" }}>
              ...
              <div style={{ background: "#1c1c1e", padding: "3px 8px", display: "flex", alignItems: "center" }}>
      ...
      {/* Floating labels — xl only to avoid overlap */}
